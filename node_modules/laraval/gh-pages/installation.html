      ...
      <div class="page-content-wrapper">
        ...
        <div class="page-content">
          ...
          <div class="page-content-inner mt-n">
            <div class="row">
              <div class="col-md-12"><p>If you are only interested in the client-side javascript library you could also simply download it from the repo <a href="https://github.com/RobinRadic/laraval/blob/master/resources/assets/jquery.validate.laravel.min.js">jquery.validate.laravel.min.js</a>.</p>
<h4><a name="node-bower" class="anchor" href="#node-bower"><span class="header-link"></span></a>Node / Bower</h4><p>If you rather not use Composer, you can also install the package using <code>npm</code> or <code>bower</code>:</p>
<pre><code class="lang-bash">npm install laraval
# or
bower install laraval
</code></pre>
<h4><a name="composer" class="anchor" href="#composer"><span class="header-link"></span></a>Composer</h4><p>Begin by installing the package through Composer.</p>
<pre><code class="lang-bash">composer require radic/laraval
</code></pre>
<p>Or</p>
...
<h4><a name="laravel" class="anchor" href="#laravel"><span class="header-link"></span></a>Laravel</h4><p>If you want to make use AJAX or rather use the provided convient initialisation methods, add the service provider and optionally the Facade;
...
<p>Optionally tell artisan to publish the config and/or views</p>
<pre><code class="lang-bash">php artisan vendor:publish --provider=&quot;Radic\Laraval\LaravalServiceProvider&quot; #all
